...
export const MASTER_BOWYERS: MasterBowyer[] = [
  {
    ...
    materials: [
      "Bamboo core (spalted bamboo) — speed, snappy acceleration, minimal hand shock.",
      "Exotic riser woods — stabilized poplar burl, wenge, panga panga, zebrawood, African padauk, Brazilian lacewood, maple, walnut, teak.",
      "Natural overlays on tips and handles — kudu or gemsbok horn, and other wild materials.",
      "Bow weights predominantly between 27lbs and 60lbs.",
    ],
    models: [
      { name: "The Crowned Eagle", description: "60-inch hybrid longbow, classic forgiving model, smooth draw to 32 inches, quiet shot cycle." },
      { name: "The Raptor", description: "57-inch super-hybrid, built for hunting and 3D target shooting, aggressive reflex-deflex geometry." },
      { name: "The Mongoose", description: "58-inch compact model, punchier and faster than the Crowned Eagle, built for maneuverable hunting setups." },
      { name: "The Ferret", description: "53-inch ultra-short bow, smooth draw to 30 inches without stacking, built for tight spaces and hunting blinds." },
    ],
    photos: [
